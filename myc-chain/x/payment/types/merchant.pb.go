...
// source: mycchain/payment/v1/merchant.proto
...
func (*Merchant) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d35615cdbed7d42, []int{0}
}
...
func (m *Merchant) GetIndex() string {
	if m != nil {
		return m.Index
	}
	return ""
...
func (m *Merchant) GetRegisteredAt() int64 {
	if m != nil {
...
func init() {
	proto.RegisterType((*Merchant)(nil), "mycchain.payment.v1.Merchant")
}

func init() {
	proto.RegisterFile("mycchain/payment/v1/merchant.proto", fileDescriptor_1d35615cdbed7d42)
}

var fileDescriptor_1d35615cdbed7d42 = []byte{
	// 220 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Merchant) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RegisteredAt != 0 {
		i = encodeVarintMerchant(dAtA, i, uint64(m.RegisteredAt))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Status) > 0 {
	...
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintMerchant(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Merchant) Size() (n int) {
	...
	if m.RegisteredAt != 0 {
		n += 1 + sovMerchant(uint64(m.RegisteredAt))
	}
	l = len(m.Creator)
	if l > 0 {
		n += 1 + l + sovMerchant(uint64(l))
